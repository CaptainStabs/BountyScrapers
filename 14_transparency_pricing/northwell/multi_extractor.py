...
for file in tqdm(os.listdir(folder)):
    ...
    df.loc[(df['contracting_method'] != 'other') & (df['standard_charge'].isna()), ['contracting_method', 'standard_charge']] = [pd.NA, pd.NA]
    # Drop rows where both 'standard_charge' and 'contracting_method' are null (std_chg_not_null)
    df.dropna(subset=['standard_charge', 'contracting_method'], how='all', inplace=True)
    df.dropna(subset=['standard_charge', 'contracting_method'], how='all', inplace=True)
