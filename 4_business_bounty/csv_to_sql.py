...
# General settings
filename = "C:\\Users\\adria\\github\\BountyScrapers\\4_business_bounty\\AR\\arkansas_3.csv"
...
def csv_to_update(filename, pk, updated_columns, fieldnames):
...
# csv_to_update(filename, pk, updated_columns, fieldnames)
