...
r = s.get("https://chrysler.emuseum.com/objects/16429")
...
# print("Date", parser.xpath("//*[@class='detailField displayDateField']/span[@property='dateCreated']/text()"))
...
# print("Description:",  parser.xpath("//*[@class='detailField toggleField descriptionField']/span[@property='description']/text()"))
