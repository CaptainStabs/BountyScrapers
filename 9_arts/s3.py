...
def check_code(r, name):
  if r.status_code == 404: print("None", end=' ')
  elif r.status_code == 403: print("Secure", end=' ')
  elif r.status_code == 301: print("Redirect", end=' ')
  elif r.status_code == 200: print("BINGO!", end=' ')
  elif r.status_code == 400: print("BadName", end=' ')
  else: print(r.status_code, end=' ')
  print(name)
  return
