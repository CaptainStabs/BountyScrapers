...
columns = ["property_id", "property_type", "physical_address", "zip5", "sale_date", "sale_price", "year_built", "county", "state", "source_url", "appraisal_total", "assessed_total", "land_area_acres", "building_area_sqft", "building_num_stories", "building_num_beds"]
        ...
        for row in tqdm(reader, total=line_count):
            ...
            try:
                land_info = {
                    ...
                    "building_num_baths": sum([row["Baths"], row["Half_Baths"] * 0.5])
