...
columns = ["property_id", "sale_date", "sale_price", "book", "page", "physical_address", "city", "zip5", "sale_type", "county", "state", "source_url"]
        ...
        for row in tqdm(reader, total=163561):
            try:
                ...
                try:
                    ...
                    land_info["sale_type"] = str(row["InstrumentType"])
