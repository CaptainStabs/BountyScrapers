...
columns = ["property_id", "book", "page", "sale_date", "sale_price", "property_type", "physical_address", "city", "county", "state", "source_url"]
        ...
        for row in tqdm(reader, total=line_count):
            try:
                land_info = {
                    ...
                    "property_type": " ".join(str(row["Dwelling_Style"]).strip().split()),
