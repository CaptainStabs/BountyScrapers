            ...
            try:
                ...
                if physical_address != "UNKNOWN" and physical_address != "FL" and physical_address != '" ,"':
                    ...
                    if parse_success:
                        ...
                        try:
                            if parsed_address[0]['StreetName'] == "VERO" and parsed_address[0]['StreetNamePostType'] == "BEACH":
                                is_vero = True
                                land_info["city"] = "VERO BEACH"
                                street_physical = str(physical_address.split("VERO BEACH")[0].strip(",").strip())
                                street_physical = street_physical.strip(",").replace('"', "")
                                land_info["physical_address"] = " ".join(street_physical.upper().split())
