...
def step_one():
    with open("districts_testing.csv", "r", encoding="utf-8") as input_source:
    ...
    with open("fix_districts.csv", "a", encoding="utf-8") as output_file:
        ...
        for index, row in df.iterrows():
            ...
            if " SD " in str(district_input):
                print("SD: " + str(district_input))
                district = district_input.replace(" SD ", " SCHOOL DISTRICT ")
                changed = True
            ...
            if changed:
                ...
                school_info["district"] = str(district).upper()
