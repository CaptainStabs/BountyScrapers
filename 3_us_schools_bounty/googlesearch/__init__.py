...
def search(query, tld='com', lang='en', tbs='0', safe='off', num=10, start=0,
    ...
    while not stop or count < stop:
        ...
        xml_etree = lxml.etree.XML(tree)
        print(xml_etree)
        address = xml_etree.xpath('/html/body/div[7]/div/div[8]/div[2]/div/div/div[2]/div/div[3]/div/div/div/div[1]/div/div/div/div/div[5]/div/div/div/span[2]/text()')
        print(address)
        yield address
