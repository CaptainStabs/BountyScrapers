...
def pull_diff(id, headers, url, file_urls):
    payload = json.dumps({
        ...
        "variables": {
        "ownerName": "dolthub",
        "repoName": "hospital-prices-allpayers",
        "pullId": str(id).strip("\n")
        },
    ...
    while next_page_token:
        ...
        while tries < 3:
            try:
                ...
                print(requests.request("POST", url, headers=headers, data=payload).text)
...
if __name__ == "__main__":
    ...
    with open("./prs/humana_prs.csv", "r") as f:
    ...
    with open("humana_finished_files.txt", "a", newline="") as f:
        f.write("url\n") # Write header
